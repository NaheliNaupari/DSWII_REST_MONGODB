...
public class LibroController {
    ...
    @GetMapping("/listarLibrosPorCategorias")
    @ResponseBody
    public List<Libro> listarLibrosPorCategorias() {
        List<String> categories = Arrays.asList("Java", "mobile");
        return service.listaLibrosPorCategorias(categories);
    }
}